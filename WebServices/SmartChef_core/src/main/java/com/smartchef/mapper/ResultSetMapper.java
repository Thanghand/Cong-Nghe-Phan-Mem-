...
public class ResultSetMapper {
	 ...
	 */
	public static final List<Map<String, Object>> toList(ResultSet rs)
			throws SQLException {
	 ...
	 */
	public static final List<Map<String, Object>> toList(ResultSet rs,
			List wantedColumnNames) throws SQLException {
	 ...
	 *             if the query fails
	 */
	public static final List<String> getColumnNames(ResultSet rs)
			throws SQLException {
